...
/* vvvv   HTML  vvvvvv */
  ...
  >
    Pet breed registration system with Smart Contract
  </h2>
  {currentAccount === '' ? (
    <button
...
<div className='text-xl font-semibold mb-20 mt-4' style={{ color: "#2c508a" , backgroundColor: "#d2e7fa",padding: "150px"}}>
  ...
  <h4 className='text-5xl font-bold mb-20 mt-12'style={{ color: "#2c508a"}}>
      ...
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Pet Name" value={bookName} onChange={(e) => setBookName(e.target.value)} style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Farm Name : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input farm animal breeds" value={bookAuthor} onChange={(e) => setBookAuthor(e.target.value)} style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Year : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Year of registration" value={bookYear} onChange={(e) => setBookYear(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Registration No. : </label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Registration No." value={bookPetnumber} onChange={(e) => setBookPetnumber(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Breed : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Breed" value={bookBreed} onChange={(e) => setBookBreed(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Sex : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Sex" value={bookSex} onChange={(e) => setBookSex(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Date of birth : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Date of birth" value={bookDateofbirth} onChange={(e) => setBookDateofbirth(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Color :  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input Color" value={bookColor} onChange={(e) => setBookColor(e.target.value)}  style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/>
      <label>Owner :  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Input AddressOwner" value={bookOwner} onChange={(e) => setBookOwner(e.target.value)} style={{ padding: "15px" , margin: "8px", width:"20em"}}/>
      <br/><br></br>
      <label value={bookFinished} onChange={(e) => setBookFinished(e.target.value)} > Enter the pet's vaccination information later after registration.  &nbsp;&nbsp;</label>
      <br/><br></br>
